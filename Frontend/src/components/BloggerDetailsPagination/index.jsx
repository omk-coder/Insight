  ...
  return (
    <div {...props}>
      <div className="flex flex-col items-center justify-start h-[40px] w-[40px]">
        <Text
          as="p"
          className="flex justify-center items-center h-[40px] w-[40px] !text-white-A700 text-lg font-normal bg-indigo-900 text-center rounded-[50%]"
        >
          {grouptwentyfive}
        </Text>
      </div>
      <div className="flex flex-col items-center justify-start h-[40px] w-[40px] ml-5">
        <Text
          as="p"
          className="flex justify-center items-center h-[40px] w-[40px] !text-indigo-900 text-lg font-normal bg-white-A700 text-center rounded-[50%]"
        >
          {grouptwentyfour}
        </Text>
      </div>
      <div className="flex flex-row justify-start items-center w-[34%] ml-10 gap-[15px] sm:ml-5">
        <Text as="p" className="!text-indigo-900 text-lg font-light">
          {next}
        </Text>
